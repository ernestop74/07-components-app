    ...
    <ThemedView margin>
      <ThemedCard>
        <SectionList 
          ...
          renderItem={ ( { item } ) => <ThemedText type='link'>{ item }</ThemedText> }
          ...
          ListHeaderComponent={ () => <ThemedText type='h1' className='font-bold mb-2'>Personajes</ThemedText> }
          ListFooterComponent={ () => (
            <ThemedText 
              type='h1' 
              className='font-bold bg-light-background dark:bg-dark-background p-2 rounded mb-6 text-center'
            >
